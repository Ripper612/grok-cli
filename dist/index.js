...
var HttpTransport = class extends EventEmitter {
  constructor(config2) {
    super();
    this.config = config2;
...
var HttpClientTransport = class extends EventEmitter {
  constructor(client) {
    super();
    this.client = client;
  }
...
var SSEClientTransport = class extends EventEmitter {
  constructor(url) {
    super();
    this.url = url;
  }
...
var StreamableHttpTransport = class extends EventEmitter {
  constructor(config2) {
    super();
    this.config = config2;
    this.connected = false;
...
var StreamableHttpClientTransport = class extends EventEmitter {
